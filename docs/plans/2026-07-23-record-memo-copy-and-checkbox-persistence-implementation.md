...
```bash
wsl.exe -d Ubuntu-22.04 -- bash -c "cd /tmp/trainingMemo && git add -- src/resources/js/utils/menuContentSessionStorage.ts src/resources/js/components/record/recordContents.vue src/resources/js/components/record/RecordTable.vue docs/plans/2026-07-23-record-memo-copy-and-checkbox-persistence-design.md docs/plans/2026-07-23-record-memo-copy-and-checkbox-persistence-implementation.md && git status"
```

ステージされたファイルが上記5件のみであることを確認してからコミットする:
